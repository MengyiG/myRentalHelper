...
export default function Header({ lang, theme, view, apiKey, scriptUrl, distanceUnit, onLangChange, onThemeChange, onViewChange, onApiKeyChange, onScriptUrlChange, onUnitChange, onManualAdd, tr }) {
  ...
  return (
    <header className="header">
      ...
      <div className="header-right">
        ...
        {/* Add listing — far right */}
        <button className="add-btn" onClick={onManualAdd} title={tr('manualAddBtn')}>
